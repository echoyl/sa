...
class Order extends Creator
{
    ...
    public $top_model_id = 0;

    public $top_menu_id = 0;

    public $appname;

    public $state_model_id = 0;

    public $goodss_model_id = 0;

    public $goods_model_id = 0;

    public $goods_page = 0;

    public $goodss_relation_id = 0;

    public $goods_items_relation_id = 0;
