    ...
    public function __construct()
    {
        ...
        $this->confJson = [
            'goods'=>[
                ...
                'form_config'=>'{"tabs":[{"tab":{"title":"基础信息"},"config":[{"columns":[{"key":"id","required":false}]},{"id":"mvqxxjxx931","columns":[{"key":["name"],"readonly":false,"required":true}]},{"columns":[{"key":"titlepic","props":{"tip":{"extra":"建议尺寸800*800"}}},{"key":["pics"],"props":{"tip":{"extra":"建议尺寸800*800"}}}]},{"id":"t7m6qz2qacu","columns":[{"key":["canshu"],"type":"formList","props":{"outside":{"columns":[{"valueType":"group","columns":[{"title":"名称","dataIndex":"key"},{"title":"参数值","dataIndex":"value"}]}]}}}]},{"columns":[{"key":"desc"}]},{"columns":[{"key":"displayorder"},{"key":"state"},{"key":["recommend"]}]}]},{"tab":{"title":"规格参数"},"config":[{"id":"feisotbwsd4","columns":[{"key":["guiges"],"type":"guigePanel","props":{"title":"规格属性","dataIndex":"guiges","fieldProps":{"columns":["price","sku","old_price","max"]}}}]}]},{"tab":{"title":"商品详情"},"config":[{"id":"jp135l2ydut","columns":[{"key":"content"}]}]}]}'
            ]
        ];
    }
