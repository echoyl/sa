...
{
    public $file_ext_arr = [
        'rar', 'doc', 'docx', 'xls', 'ppt', 'zip', 'pdf', 'xlsx', 'bin', 'mp4', 'mp3', 'txt',
    ];
     ...
     * @param  int  $type  是否是文件
     * @param  bool  $insert_db  是否插入数据库
     * @param  bool  $toSize  是否resize图片宽高
     * @return void
     */
